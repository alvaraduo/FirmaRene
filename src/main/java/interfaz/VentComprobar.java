...
public class VentComprobar extends JFrame implements ActionListener {

    public static final String SUBIR_ARCHIVO = "Subir archivo";
    public static final String SUBIR_FIRMA = "Subir firma";
    public static final String SUBIR_CLAVE_PUBLICA = "Subir clave pública";
    ...
    public VentComprobar(FirmaDigitalAppInit inicio) {
        this.inicio = inicio;
        rutaArchivo = "";
        rutaFirma = "";
        rutaClavePublica = "";
        ...
        JButton butSubirArchivo = new JButton("Cargar archivo");
        ...
        JButton butSubFirma = new JButton("Cargar firma");
        ...
        JButton butSubClavePublica = new JButton("Cargar clave pública");
        ...
        JButton butMenuPrincipal = new JButton("Volver al menú principal");
    ...
    public void subirClavePublica() {
        JFileChooser fc = new JFileChooser();
        fc.setDialogTitle("Seleccionar clave pública");
    ...
    public void comprobar() {
        if (rutaArchivo.equals("") || rutaFirma.equals("") || rutaClavePublica.equals("")) {
            JOptionPane.showMessageDialog(this, "Para comprobar una firma debe especificar un archivo, la firma y la clave pública del remitente",
